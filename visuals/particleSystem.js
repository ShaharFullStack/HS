...
const ACCENT_PARTICLE_COUNT = 2000;
const PINCH_THRESHOLD_CLOSED = 30; // World units for pinch detection
const PINCH_THRESHOLD_OPEN = 30;   // Slightly larger to prevent flickering on release
const ATTRACTION_RADIUS = 70;      // Radius within which particles are attracted to a pinch
        ...
        this.particleSystem.material = new THREE.ShaderMaterial({
            ...
            fragmentShader: `
                ...
                void main() {
                    ...
                    float alpha = smoothstep(0.5, 0.3 - vPulse * 0.2, dist);
